...
**** Current
   ...
   | Source                   | Input                    | Output                                      |
   |--------------------------+--------------------------+---------------------------------------------|
   | Audio In                 | /sampled/ TargetDataLine | discreet ByteArray /mic-sample-buffer/      |
   | /mic-sample-buffer/      | self                     | ByteArrayOutputStream /shout-output-stream/ |
   | /shout-output-stream/    | self                     | clojure.java.shell ByteArray                |
   | encoder output ByteArray | shout-input-stream       | shout-output-stream                         |

**** Target
     No discrete steps. A continuous stream flows from Audio-In to Encoder to libshout.
